...
| ------------------------------------------- | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PORT`                                      | `7869`                                                   | Server port. Keep Android builds, launchers, Docker, and Termux on the same value. The Android APK is only a WebView shell for the Termux-served app; it must point at the same port as the running Termux server.                                                                                                                                                                                                                  |
